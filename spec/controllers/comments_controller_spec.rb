  ...
  context "Authenticated user: " do
    ...
    context "Unauthenticated user: " do
      it "should not allow access to create a review" do
        post :create, :kata_id => mock_kata.id
        flash[:alert].should == "You need to sign in before continuing."
        response.should redirect_to("/users/sign_in")
      end

      it "should not allow access to edit a review" do
        get :edit, :kata_id => mock_kata.id, :id => mock_review.id
        flash[:alert].should == "You need to sign in before continuing."
        response.should redirect_to("/users/sign_in")
      end

      it "should not allow access to update a review" do
        put :update, :kata_id => mock_kata.id, :id => mock_review.id
        flash[:alert].should == "You need to sign in before continuing."
        response.should redirect_to("/users/sign_in")
      end
      it "should not allow access to delete a review" do
        delete :destroy, :kata_id => mock_kata.id, :id => mock_review.id
        flash[:alert].should == "You need to sign in before continuing."
        response.should redirect_to("/users/sign_in")
      end
    end
    ...
    context "Authenticated user: " do
      ...
      describe "POST create" do
        context "with valid params" do
          before(:each) do
            ...
            post :create, :kata_id => mock_kata.id, :review => mock_review
          end
        ...
        context "with invalid params" do
          before(:each) do
            ...
            post :create, :kata_id => mock_kata.id, :review => {}
          end
      ...
      describe "DELETE destroy the review" do
        ...
        it "should correctly delete the review " do
          ...
          delete :destroy, :id => mock_review.id, :kata_id => mock_kata.id
        end
      end
